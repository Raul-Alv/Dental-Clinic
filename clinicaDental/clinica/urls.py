...
urlpatterns = [
    ...
    path("procedimiento/<uuid:id>/", views.getProcedimiento, name='procedimiento_detail'),
    path("procedimiento/<uuid:id>/update/", views.updateProcedimiento, name='procedimiento_update'),
    path("procedimiento/<uuid:id>/delete/", views.deleteProcedimiento, name='procedimiento_delete'),
    path('procedimiento/export/rdf/', rdfConverter.export_procedimientos_rdf, name='procedimiento_export_rdf'),
    path("procedimiento/export/<uuid:procedimiento_id>/rdf", rdfConverter.export_procedimiento_rdf, name="export_procedure_rdf"),
